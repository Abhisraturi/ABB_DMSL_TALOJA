...
log_path = os.path.join(LOG_DIR, "AN_2_Cal.log")
...
INPUT_STATUS_REGS = {
    1202: {"name": "N₂O ZERO", "delay": 120, "max_duration_m": 10, "capture": ["N₂O"]},
    1203: {"name": "N₂O SPAN",  "delay": 60,  "max_duration_m": 5,  "capture": ["N₂O"]}
}

INPUT_REG_MAP = {
    "N₂O": (0, "ABCD", 130, 114, 116, 100),
}
