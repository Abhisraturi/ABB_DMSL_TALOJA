# Configuration
$baseUrl = "http://desktop-f4fk4gn/ReportServer/Pages/ReportViewer.aspx?%2fANALYSER_REPORT%2fN%e2%82%82O+Abator+Inlet+Linearity"
...
$path = Join-Path $saveDir "N2O_Abator_Inlet_Linearity_$($ts).pdf"
